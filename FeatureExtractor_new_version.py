...
def save_features(dataset, atlas_names):
    ...
    corr_2d_all_atlas = FeatureExtractor(atlas_names=atlas_names, kind='correlation', vectorize=False).fit_transform(X,y)
    ...
    for single_atlas in atlas_names:   
        ...
        corr_1d_single_atlas = corr_1d_all_atlas[corr_1d_all_atlas.columns[corr_1d_all_atlas.columns.str.contains(single_atlas)]]
        # Each atlas, 2D
