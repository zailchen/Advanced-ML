...
if __name__ == '__main__':
    ...
    ae1_model_path = format_config("./model/model_basc064/{experiment}_autoencoder-1.ckpt", {
        "experiment": feature,
    })
    ae2_model_path = format_config("./model/model_basc064/{experiment}_autoencoder-2.ckpt", {
        "experiment": feature,
    })
    nn_model_path = format_config("./model/model_basc064/{experiment}_mlp.ckpt", {
        "experiment": feature,
    })
